import type { IPC_ACTIONS_TYPE } from '../../ipcActions';
import { FILE_PICKER_OPEN_TYPE, FILE_PICKER_RES, FileSystemItem } from './file';
import { CropRange } from './video';

type IPC_ACTIONS_VALUE = IPC_ACTIONS_TYPE[keyof IPC_ACTIONS_TYPE];
...
type IpcActionHandlers = {
    ...
    SAVE_BASE64_IMAGE: (data: { imageData: string; enPath?: string }) =>
...
type InferIpcReturn<K extends keyof IpcChannels, T = unknown> =
